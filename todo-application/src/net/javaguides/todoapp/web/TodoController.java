...
//                                motiv(request, response);
        ...
        private void motiv(HttpServletRequest request, HttpServletResponse response)
                throws SQLException, IOException, ServletException{
//                RequestDispatcher dispatcher = request.getRequestDispatcher("todo/motivation.jsp");
//		dispatcher.forward(request, response);
                response.sendRedirect("motiv");
        }
